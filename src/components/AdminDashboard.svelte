<script>
  ...
  const totalExpenseAll = $derived(usersData.reduce((s, u) => s + Number(u.totalExpense || 0), 0));
  const totalMonthlyAll = $derived(usersData.reduce((s, u) => s + Number(u.monthlyExpense || 0), 0));
</script>
...
<div class="admin-page animate-fade-in pb-12">
  ...
  <div class="admin-stats-grid">
    ...
    <div class="admin-stat-card glass-card">
      <div class="stat-icon-box stat-expense">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
      ...
      <div class="stat-info">
        ...
        <span class="stat-value-sm">{formatRupiah(totalExpenseAll)}</span>
        <span class="stat-sub">akumulasi semua akun</span>
      </div>
    </div>

    <div class="admin-stat-card glass-card">
      <div class="stat-icon-box stat-month">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
      ...
      <div class="stat-info">
        ...
        <span class="stat-value-sm">{formatRupiah(totalMonthlyAll)}</span>
        <span class="stat-sub">semua pengguna aktif</span>
      </div>
    </div>
  </div>
